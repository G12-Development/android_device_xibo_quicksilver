...
FACTORY_PATH := device/xibo/quicksilver/factory
...
else ifneq ("$(wildcard vendor/xibo/quicksilver/radio/bootloader.img)","")
	$(hide) $(call aml-copy-install-file, vendor/xibo/quicksilver/radio/bootloader.img, u-boot.bin)
else
...
ifneq ("$(wildcard $(FACTORY_PATH)/u-boot.bin)","")
	...
	$(hide) $(call aml-copy-upgrade-file, vendor/xibo/quicksilver/radio/bootloader.img, u-boot.bin)
else
	$(error "no u-boot.bin found in $(FACTORY_PATH)")
endif
	...
	$(hide) $(call aml-copy-upgrade-file, $(PRODUCT_OUT)/odm.img)
	$(hide) $(call aml-copy-upgrade-file, $(PRODUCT_OUT)/system.img)
	$(hide) $(call aml-copy-upgrade-file, $(PRODUCT_OUT)/vendor.img)
